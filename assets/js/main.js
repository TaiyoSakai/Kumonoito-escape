 ...
 *********************************************************************************************************/
var count =0;
var info=(localStorage.getItem('counter'));

const jo = Vue.createApp({
  data(){
    return{
      choice1:'A',
      choice2:'A',
  ...
  methods: {
    buttona: function () {
      return this.choice1='B'
    },
    buttonb: function () {
      return this.choice2='B'
    },
    buttonshout: function () {
      return this.shout='B';
    },
    buttoncut: function () {
      return this.cut='B';
